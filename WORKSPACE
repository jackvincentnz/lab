...
# e.g. https://mvnrepository.com/artifact/org.springframework.boot/spring-boot-dependencies/3.1.5
SPRING_BOOT_DEPENDENCIES = [
    "org.apache.commons:commons-lang3:3.12.0",
    "org.apache.kafka:kafka-clients:3.4.1",
    "org.apache.kafka:kafka-group-coordinator:3.4.1",
    ...
    "org.springframework.boot:spring-boot-loader:3.1.5",
