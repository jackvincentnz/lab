package nz.geek.jack.task.infrastructure.web.gql.task;
...
import nz.geek.jack.task.infrastructure.web.gql.task.data.AddTaskInput;
import nz.geek.jack.task.infrastructure.web.gql.task.data.MarkTaskCompletedInput;
import nz.geek.jack.task.infrastructure.web.gql.task.data.TaskType;
