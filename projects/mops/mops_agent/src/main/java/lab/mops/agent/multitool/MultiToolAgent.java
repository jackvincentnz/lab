  ...
  public static BaseAgent initAgent() {
    ...
    try {
      ...
      return LlmAgent.builder()
          ...
          2. **Identify the appropriate tools.** You will be provided with tools for a marketing planning saas application (create, and get all budgets). You will also be able to web search via Google Search. Identify one **or more** appropriate tools to accomplish the user's request.
          ...
          5. **Analyze the tools' results, and provide insights back to the user.** Return the tools' result in a human-readable format. State which tools you called, if any. If your result contains multiple items, always use a markdown table to report back. If there is any code, or timestamp, in the result, format the code with markdown backticks, or codeblocks.
