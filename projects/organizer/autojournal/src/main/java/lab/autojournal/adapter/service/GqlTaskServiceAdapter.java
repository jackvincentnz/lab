...
import lab.autojournal.application.Task;
import lab.autojournal.application.TaskService;
import lab.task.adapter.gql.schema.client.TaskGraphQLQuery;
import lab.task.adapter.gql.schema.client.TaskProjectionRoot;
