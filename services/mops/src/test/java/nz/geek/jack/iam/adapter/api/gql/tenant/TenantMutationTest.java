...
import nz.geek.jack.iam.api.gql.types.ProvisionTenantInput;
import nz.geek.jack.iam.api.gql.types.Tenant;
import nz.geek.jack.iam.application.identity.TenantCommandService;
...
class TenantMutationTest {
  ...
  void provisionTenant_mapsAndReturnsTenant() {
    ...
    var tenant = nz.geek.jack.iam.domain.identity.Tenant.provision(name);
